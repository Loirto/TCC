...
\usepackage{float}                          % Posicionamento de figuras = opção H - coloca MESMO aqui
%\usepackage{hyperref}                      % Insere links em dvi e pdf
\usepackage{doipubmed}                      % inserção de links doi nas referências.     
\usepackage[numbers,sort&compress]{natbib}  % Agrupar referências
...
\usepackage{tocbibind}                      % Inseri Sumário, referências no tableofcontents.
...
\ifpdf
  \usepackage[linkcolor=black,urlcolor=black,citecolor=black,
