...
\subsection{Cabeçalho}
   ...
   e_shstrndx - Indice das seções linkado com a tabela de strings.
...
\subsection Tabela de Cabeçalhos de Seção (SHT)
   ...
   sh_name: Indice para a tabela de string de cabeçalho de seção, descrita acima.
   ...
   sh_offset: Indica o inicio da seção no arquivo.
   ...
   sh_addralign: Verificação do alinhamento dos blocos definidos por sh_addr, sh_addr deve ser divisivel por sh_addralign.
...
\subsection Tabela de Símbolos (Symbol table)
   ...
   st_name: Indice para a tabela de strings que contém o nome do símbolo. Se possui 0, o símbolo não tem nome.
   ...
   st_shndx: Indice para o cabeçalho de seção utilizada.
